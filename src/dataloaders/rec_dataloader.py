...
class RecDataloader(AbstractDataloader):
    ...
    def _get_train_dataset(self):
        dataset = RecTrainDataset(self.train, self.train_b, self.seg_len, self.mask_prob,
                                  self.num_items, self.target_code, self.predict_only_target)
        return dataset
    ...
    def _get_eval_dataset(self):
        dataset = RecEvalDataset(self.train, self.train_b, self.val, self.val_b, self.val_num,
                                 self.seg_len, self.num_items, self.target_code, self.val_negative_samples)
        return dataset
